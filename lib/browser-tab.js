...
export default class BrowserTab {
  ...
  setLiveReload(reload) {
    this.html.btn.livereload.classList.toggle('active', reload);
  }
  ...
  setListeners() {
    ...
    this.html.btn.livereload.addEventListener('click', () => {
      this.html.btn.livereload.classList.toggle('active')
    })
  ...
  devtoolsShow() {
    // devtools: this.element.querySelector('#devtools'),
    // this.html.devtools = this.element.querySelector('#devtools');
    // const dev = (item) => {
    // remote.webContents.fromId(this.html.devtools.getWebContentsId()).executeJavaScript("window.location.reload()");
    //   console.log(this.getWebContents().devToolsWebContents);
    // }
    // setTimeout(dev, 1000);
    // console.log(this.getWebContents().debugger);
    // this.getWebContents().debugger.attach();
    // this.getWebContents().debugger.detach();
    // this.getWebContents().setDevToolsWebContents(this.html.devtools);
    // this.getWebContents().setDevToolsWebContents(remote.webContents.fromId(this.html.devtools.getWebContentsId()));
    this.getWebContents().openDevTools();
    // this.getWebContents().openDevTools({ mode: 'undocked' });
    // console.log(this.getWebContents().devToolsWebContents);
    // this.getWebContents().openDevTools();
    // this.getWebContents().openDevTools({ mode: 'undocked' });
    // this.getWebContents().setDevToolsWebContents(new remote.BrowserWindow());
    // this.html.webview.openDevTools();
    // remote.webContents.fromId(this.html.devtools.getWebContentsId()).executeJavaScript("window.location.reload()");
    // this.html.devtools.openDevTools();
  }
  devtoolsHide() {
